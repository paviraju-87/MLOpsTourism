...
# Read the data from hugging face
Xtrain_path = "hf://datasets/PaviRaju/tourism-wellness-package-purchase/Xtrain.csv"
Xtest_path = "hf://datasets/PaviRaju/tourism-wellness-package-purchase/Xtest.csv"
ytrain_path = "hf://datasets/PaviRaju/tourism-wellness-package-purchase/ytrain.csv"
ytest_path = "hf://datasets/PaviRaju/tourism-wellness-package-purchase/ytest.csv"
...
# Fetch the Categorical and Numerical Columns
categoricalCols = Xtrain.select_dtypes(include='object').columns
numericalCols = Xtrain.select_dtypes(include=np.number).columns.drop(['Unnamed: 0'], errors='ignore')
...
preprocessor = make_column_transformer(
    (StandardScaler(), numericalCols),
    (OneHotEncoder(handle_unknown='ignore'), categoricalCols)
)
